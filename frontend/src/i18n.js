  ...
  en: {
    translation: {
      ...
      "settings": {
        "language": "Language",
        "currency": "Currency",
        "currency_desc": "Used throughout the app for salary calculations and financial displays.",
        "selected": "Selected",
        "timezone": "Timezone",
        "timezone_desc": "Used for displaying shift times and scheduling. Shift times entered in the app are interpreted in this timezone.",
        "current_time": "Current time",
        "sig_verification": "Signature Verification",
        "sig_verification_desc": "When enabled, each staff member's signature on salary documents is compared to their stored reference signature. If signatures differ too much the document is rejected. Staff without a reference signature are always allowed through.",
        "verification_active": "Active — signatures are being verified",
        "ref_signatures": "Reference Signatures",
        "ref_signatures_desc": "Assign a reference signature to each staff member for comparison.",
        "loading": "Loading…",
        ...
        "amounts_recalculated": "All displayed amounts will be recalculated",
        "from": "From",
        "to": "To",
        "fetching_rate": "Fetching live exchange rate…",
        "rate": "Rate",
        "rate_unavailable": "Rate unavailable",
        "offline_rate": "using offline fallback rate",
        "reload_notice": "The page will reload after switching. Amounts stored in the database remain in CZK — only the display is converted.",
        "switch_to": "Switch to {{code}}",
        "assign_reference": "Assign Reference Signature",
        "reference_saved": "Reference saved",
        "reference_saved_desc": "Future salary signatures for {{name}} will be compared against this.",
        "done": "Done",
        "draw_signature": "Draw the staff member's typical signature below.",
        "saving": "Saving…",
        "save_reference": "Save Reference",
        "failed_save_ref": "Failed to save reference signature",
      ...
      "doctors_report": {
        ...
        "back": "← Back",
        "title": "Patient Revenue Report",
        "period": "Period",
        "total_salary_all": "Total Salary (All Doctors)",
        "no_doctors": "No doctors found",
        "doctor_meta": "Doctor · Commission {{rate}}%",
        "total_salary": "Total Salary",
        "col_patient": "Patient",
        "col_paid": "Paid",
        "col_lab_cost": "Lab Cost",
        "col_net": "Net",
        "no_patients": "No patients in this period",
        "base_salary": "Base Salary",
        "commission": "Commission ({{rate}}%)",
        "lab_fees_deduction": "Lab Fees Deduction",
        "adjustments": "Adjustments",
        "grand_total": "Grand Total — All Doctors",
        "failed_load": "Failed to load report",
        "failed_pdf": "Failed to download PDF"
      },
      "salary_report": {
        "title": "Salary Report",
        "download_pdf": "Download PDF",
        ...
        "missing_staff_id": "Missing staff id",
        "failed_load": "Failed to load salary report",
        "failed_pdf": "Failed to download salary report",
        "stat_staff": "Staff",
        "stat_role": "Role",
        "stat_last_payment": "Last Payment",
        "stat_total_salary": "Total Salary",
        "patient_payments": "Patient Payments",
        "col_patient": "Patient",
        "col_gross": "Gross",
        "col_lab_fee": "Lab Fee",
        "col_net": "Net",
        "no_patients": "No unpaid patient payments for this period",
        "base_salary": "Base Salary",
        "commission": "Commission ({{rate}}%)",
        "lab_fees_deduction": "Lab Fees Deduction",
        "adjustments": "Adjustments",
        ...
        "col_hours": "Hours",
        "col_note": "Note",
        "no_timesheets": "No timesheets for this period",
        "signature": "Signature",
        "signer_name": "Signer Name",
      ...
      "my_income_dashboard": {
        ...
        "no_hours": "No hours logged for this period",
        "payment_history": "Payment History",
        "col_date": "Date",
        "col_amount": "Amount",
        "col_note": "Note",
        "no_payments": "No payments recorded",
        "failed_load": "Unable to load income data"
      }
    }
  },
  ru: {
    translation: {
      ...
      "settings": {
        "language": "Язык",
        "currency": "Валюта",
        "currency_desc": "Используется в приложении для расчётов зарплат и финансовых отображений.",
        "selected": "Выбрано",
        "timezone": "Часовой пояс",
        "timezone_desc": "Используется для отображения времени смен и планирования. Время смен вводится в выбранном часовом поясе.",
        "current_time": "Текущее время",
        "sig_verification": "Проверка подписи",
        "sig_verification_desc": "Когда включено, подпись каждого сотрудника на зарплатных документах сравнивается с эталонной. Если подписи слишком различаются, документ отклоняется. Сотрудники без эталонной подписи всегда пропускаются.",
        "verification_active": "Активно — подписи проверяются",
        "ref_signatures": "Эталонные подписи",
        "ref_signatures_desc": "Назначьте эталонную подпись каждому сотруднику для сравнения.",
        "loading": "Загрузка…",
        "no_staff": "Сотрудники не найдены.",
        "reference_set": "Эталон задан",
        "no_reference": "Нет эталона",
        "update": "Обновить",
        "assign": "Назначить",
        "remove": "Удалить",
        "change_currency": "Изменить валюту",
        "amounts_recalculated": "Все суммы будут пересчитаны",
        "from": "С",
        "to": "ПО",
        "fetching_rate": "Получение актуального курса…",
        "rate": "Курс",
        "rate_unavailable": "Курс недоступен",
        "offline_rate": "используется офлайн-курс",
        "reload_notice": "Страница перезагрузится после смены. Суммы в базе данных хранятся в CZK — конвертируется только отображение.",
        "switch_to": "Переключить на {{code}}",
        "assign_reference": "Назначить эталонную подпись",
        "reference_saved": "Эталон сохранён",
        "reference_saved_desc": "Подписи в зарплатных документах {{name}} будут сравниваться с этим эталоном.",
        "done": "Готово",
        "draw_signature": "Нарисуйте типичную подпись сотрудника ниже.",
        "saving": "Сохранение…",
        "save_reference": "Сохранить эталон",
        "failed_save_ref": "Не удалось сохранить эталонную подпись",
        "failed_save_setting": "Не удалось сохранить настройку."
      },
      "doctors_report": {
        "from": "С",
        "to": "ПО",
        "loading": "Загрузка…",
        "load_report": "Загрузить отчёт",
        "generating_pdf": "Генерация PDF…",
        "download_pdf": "Скачать PDF",
        "back": "← Назад",
        "title": "Отчёт по пациентам",
        "period": "Период",
        "total_salary_all": "Общая зарплата (все врачи)",
        "no_doctors": "Врачи не найдены",
        "doctor_meta": "Врач · Комиссия {{rate}}%",
        "total_salary": "Итого зарплата",
        "col_patient": "Пациент",
        "col_paid": "Оплачено",
        "col_lab_cost": "Лаб. расходы",
        "col_net": "Чистая сумма",
        "no_patients": "Пациентов за этот период нет",
        "base_salary": "Базовый оклад",
        "commission": "Комиссия ({{rate}}%)",
        "lab_fees_deduction": "Удержание за лабораторию",
        "adjustments": "Корректировки",
        "grand_total": "Итого — все врачи",
        "failed_load": "Не удалось загрузить отчёт",
        "failed_pdf": "Не удалось скачать PDF"
      },
      "salary_report": {
        ...
        "missing_staff_id": "Не указан ID сотрудника",
        "failed_load": "Не удалось загрузить зарплатный отчёт",
        "failed_pdf": "Не удалось скачать зарплатный отчёт",
        "stat_staff": "Сотрудник",
        "stat_role": "Роль",
        "stat_last_payment": "Последняя выплата",
        "stat_total_salary": "Итого зарплата",
        "patient_payments": "Платежи пациентов",
        "col_patient": "Пациент",
        "col_gross": "Валовая сумма",
        "col_lab_fee": "Лаб. расходы",
        "col_net": "Чистая сумма",
        "no_patients": "Нет невыплаченных платежей пациентов за этот период",
        "base_salary": "Базовый оклад",
        "commission": "Комиссия ({{rate}}%)",
        "lab_fees_deduction": "Удержание за лабораторию",
        "adjustments": "Корректировки",
        ...
        "col_date": "Дата",
        "col_time_range": "Промежуток",
        "col_hours": "Часы",
        "col_note": "Примечание",
        "no_timesheets": "Нет записей за этот период",
        "signature": "Подпись",
        "signer_name": "Имя подписанта",
        "signature_field": "Поле подписи",
        "full_name_placeholder": "Полное имя",
        "clear_signature": "Очистить подпись",
        "confirm_signature": "Подтвердить подпись",
        "signed_at": "Подписано {{datetime}}"
      },
      "my_income_dashboard": {
        "title": "Мой доход",
        "from": "С",
        ...
        "total_pay": "Итого выплата",
        "base": "Базовые",
        "income_trend": "Динамика дохода",
        "no_hours": "Нет записанных часов за этот период",
        "payment_history": "История выплат",
        "col_date": "Дата",
        "col_amount": "Сумма",
        "col_note": "Примечание",
        "no_payments": "Нет записанных выплат",
        "failed_load": "Не удалось загрузить данные о доходах"
      }
    }
  },
  cs: {
    translation: {
      ...
      "settings": {
        "language": "Jazyk",
        "currency": "Měna",
        "currency_desc": "Používá se v celé aplikaci pro výpočty mezd a finanční zobrazení.",
        "selected": "Vybráno",
        "timezone": "Časové pásmo",
        "timezone_desc": "Používá se pro zobrazení časů směn a plánování. Časy směn zadané v aplikaci jsou interpretovány v tomto časovém pásmu.",
        "current_time": "Aktuální čas",
        "sig_verification": "Ověření podpisu",
        "sig_verification_desc": "Pokud je povoleno, podpis každého zaměstnance na mzdových dokumentech je porovnáván s uloženým referenčním podpisem. Pokud se podpisy příliš liší, dokument je odmítnut. Zaměstnanci bez referenčního podpisu jsou vždy povoleni.",
        "verification_active": "Aktivní — podpisy jsou ověřovány",
        "ref_signatures": "Referenční podpisy",
        "ref_signatures_desc": "Přiřaďte referenční podpis každému zaměstnanci pro porovnání.",
        "loading": "Načítání…",
        "no_staff": "Žádní zaměstnanci nenalezeni.",
        "reference_set": "Referenční podpis nastaven",
        "no_reference": "Bez reference",
        "update": "Aktualizovat",
        "assign": "Přiřadit",
        "remove": "Odebrat",
        "change_currency": "Změnit měnu",
        "amounts_recalculated": "Všechny zobrazené částky budou přepočítány",
        "from": "Od",
        "to": "Do",
        "fetching_rate": "Načítání aktuálního kurzu…",
        "rate": "Kurz",
        "rate_unavailable": "Kurz nedostupný",
        "offline_rate": "použit offline záložní kurz",
        "reload_notice": "Stránka se po přepnutí znovu načte. Částky uložené v databázi zůstávají v CZK — převádí se pouze zobrazení.",
        "switch_to": "Přepnout na {{code}}",
        "assign_reference": "Přiřadit referenční podpis",
        "reference_saved": "Referenční podpis uložen",
        "reference_saved_desc": "Budoucí podpisy na mzdových dokumentech {{name}} budou porovnávány s tímto podpisem.",
        "done": "Hotovo",
        "draw_signature": "Nakreslete typický podpis zaměstnance níže.",
        "saving": "Ukládání…",
        "save_reference": "Uložit referenci",
        "failed_save_ref": "Nepodařilo se uložit referenční podpis",
        "failed_save_setting": "Nepodařilo se uložit nastavení."
      },
      "doctors_report": {
        "from": "Od",
        "to": "Do",
        "loading": "Načítání…",
        "load_report": "Načíst přehled",
        "generating_pdf": "Generování PDF…",
        "download_pdf": "Stáhnout PDF",
        "back": "← Zpět",
        "title": "Přehled příjmů pacientů",
        "period": "Období",
        "total_salary_all": "Celková mzda (všichni lékaři)",
        "no_doctors": "Žádní lékaři nenalezeni",
        "doctor_meta": "Lékař · Provize {{rate}}%",
        "total_salary": "Celková mzda",
        "col_patient": "Pacient",
        "col_paid": "Zaplaceno",
        "col_lab_cost": "Lab. náklady",
        "col_net": "Čistá částka",
        "no_patients": "Žádní pacienti v tomto období",
        "base_salary": "Základní plat",
        "commission": "Provize ({{rate}}%)",
        "lab_fees_deduction": "Srážka za lab. poplatky",
        "adjustments": "Úpravy",
        "grand_total": "Celkem — všichni lékaři",
        "failed_load": "Nepodařilo se načíst přehled",
        "failed_pdf": "Nepodařilo se stáhnout PDF"
      },
      "salary_report": {
        "title": "Mzdový výkaz",
        "download_pdf": "Stáhnout PDF",
        "back": "← Zpět",
        "loading": "Načítání výkazu...",
        "missing_staff_id": "Chybí ID zaměstnance",
        "failed_load": "Nepodařilo se načíst mzdový výkaz",
        "failed_pdf": "Nepodařilo se stáhnout mzdový výkaz",
        "stat_staff": "Zaměstnanec",
        "stat_role": "Role",
        "stat_last_payment": "Poslední platba",
        "stat_total_salary": "Celková mzda",
        "patient_payments": "Platby pacientů",
        "col_patient": "Pacient",
        "col_gross": "Hrubá částka",
        "col_lab_fee": "Lab. poplatek",
        "col_net": "Čistá částka",
        "no_patients": "Žádné nezaplacené platby pacientů za toto období",
        "base_salary": "Základní plat",
        "commission": "Provize ({{rate}}%)",
        "lab_fees_deduction": "Srážka za lab. poplatky",
        "adjustments": "Úpravy",
        "work_schedule": "Pracovní rozvrh",
        "working_days": "Pracovní dny",
        "total_hours": "Celkem hodin",
        "hourly_rate": "Hodinová sazba",
        "col_date": "Datum",
        "col_time_range": "Časový úsek",
        "col_hours": "Hodiny",
        "col_note": "Poznámka",
        "no_timesheets": "Žádné záznamy pro toto období",
        "signature": "Podpis",
        "signer_name": "Jméno podepisujícího",
        "signature_field": "Pole podpisu",
        "full_name_placeholder": "Celé jméno",
        "clear_signature": "Vymazat podpis",
        "confirm_signature": "Potvrdit podpis",
        "signed_at": "Podepsáno {{datetime}}"
      },
      "my_income_dashboard": {
        "title": "Můj příjem",
        "from": "Od",
        ...
        "apply": "Použít",
        "export_csv": "Exportovat CSV",
        "print_pdf": "Tisknout PDF",
        "system_error": "SYSTÉMOVÁ CHYBA: {{error}}",
        "employment": "Pracovní zařazení",
        "since": "Od {{date}}",
        "total_hours": "Celkem hodin",
        "regular": "Řádné",
        "overtime": "Přesčasy",
        "total_pay": "Celková výplata",
        "base": "Základní",
        "income_trend": "Trend příjmů",
        "no_hours": "Žádné zaznamenané hodiny pro toto období",
        "payment_history": "Historie výplat",
        "col_date": "Datum",
        "col_amount": "Částka",
        "col_note": "Poznámka",
        "no_payments": "Žádné zaznamenané výplaty",
        "failed_load": "Nepodařilo se načíst data o příjmech"
      }
    }
  }
};
